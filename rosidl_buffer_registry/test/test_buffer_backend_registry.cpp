...
using rosidl_buffer_registry::BufferBackendRegistry;
using rosidl_buffer_registry::test::DummyBufferBackend;
using rosidl_buffer_registry::test::DummyBufferImpl;
